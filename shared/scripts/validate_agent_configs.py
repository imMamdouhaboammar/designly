...
EXPECTED_AGENTS = [
    "designly-director", "strategy-planner", "brand-guardian", "taste-analyst",
...
def main() -> int:
    ...
    check(set(present) == set(EXPECTED_AGENTS), f"exactly 9 expected agents present (found {len(present)})", errors)
