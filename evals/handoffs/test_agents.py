...
READ_ONLY_AGENTS = [
    "strategy-planner", "creative-director", "brand-guardian", "taste-analyst", "structure-critic",
...
def main() -> int:
    ...
    if len(present) != 10:
        failures += 1
        print(f"FAIL expected 10 agents, found {len(present)}")
    else:
        print("PASS exactly 10 agents present")
